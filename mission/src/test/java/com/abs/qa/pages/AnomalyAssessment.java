...
public class AnomalyAssessment extends BaseTag {
    ...
    public AnomalyAssessment(WebDriver driver) {
        super(driver);
    }
    ...
    public void clickRBISaveButton() {
        forcedWaitForTwoSeconds();
        saveAndContinueButtonElement.get(1).click();
        forcedWaitForTwoSeconds();
    }

    public void clickCMAnomalySaveButton() {
        forcedWaitForTwoSeconds();
        saveAndContinueButtonElement.get(1).click();
        forcedWaitForTwoSeconds();
    }
